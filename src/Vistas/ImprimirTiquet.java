 ...
 * @author Usuario
 */
public class ImprimirTiquet extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ImprimirTiquet
     */
    public ImprimirTiquet() throws SQLException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImprimirTiquet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ImprimirTiquet().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ImprimirTiquet.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
